 ...
 <body>
  ...
  <div id="main_container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
      <a class="navbar-brand" href="http://localhost/FEBBRAIO/php-boolcrud-ajax/">Hotel Booleana - GUESTS</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <?php if (getThePageName() !== 'new.php') { ?>
            <li class="nav-item">
                <a class="nav-link" href="http://localhost/FEBBRAIO/php-boolcrud-ajax/new.php">Add New<i class="fas fa-plus-square ml-3"></i></a>
            </li>
          <?php  } ?>
        </ul>
      </div>
